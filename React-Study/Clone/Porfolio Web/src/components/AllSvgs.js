...
// SVGR Playground를 이용해  svg를 컴포넌트로 만든다.

export function PowerBtn({ fill = 'currentColor', props }) {
  return (
    <svg
      aria-hidden="true"
      data-prefix="fas"
...
export function Github({ fill = 'currentColor', props }) {
    return (
      <svg
        aria-hidden="true"
        data-prefix="fab"
...
export function Twitter({ fill = 'currentColor', props }) {
    return (
      <svg
        aria-hidden="true"
        data-prefix="fab"
...
export function Facebook({ fill = 'currentColor', props }) {
    return (
      <svg
        aria-hidden="true"
        data-prefix="fab"
...
export function YouTube({ fill = 'currentColor', props }) {
    return (
      <svg
        aria-hidden="true"
        data-prefix="fab"
...
export function YinYang({ fill = 'currentColor', props }) {
    return (
      <svg
        aria-hidden="true"
        data-prefix="fas"
...
export function Anchor({ fill = 'currentColor', props }) {
  return (
    <svg
      aria-hidden="true"
      data-prefix="fas"
...
export function Link({ fill = 'currentColor', props }) {
  return (
    <svg
      aria-hidden="true"
      data-prefix="fas"
